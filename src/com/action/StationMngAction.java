...
public class StationMngAction {
    ...
    public String Update() throws Exception {
        StationEntity routeEntity = this.setStationEntity();
        if (stationManagerServer.UpdateStation(routeEntity)) {
            return "success";
        } else {
            return "fail";
        }
    ...
    public String Add() throws Exception {
        StationEntity routeEntity = this.setStationEntity();
        if (stationManagerServer.AddStation(routeEntity)) {
            return "success";
        } else {
            return "fail";
        }
    ...
    public String Delete() throws Exception {
        StationEntity routeEntity = this.setStationEntity();
        if (stationManagerServer.DeleteStation(routeEntity)) {
            return "success";
        } else {
            return "fail";
        }
